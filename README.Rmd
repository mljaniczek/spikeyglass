...
Input list of sample by feature matrices (one matrix for each group), specify group or fused penalty, and specify priors for simultaneous shrinkage and model selection. 
